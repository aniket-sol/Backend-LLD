...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        ls.add(new Student("Aniket", 95, "CU"));
        ls.add(new Student("Umang", 80, "XYZ"));
        ls.add(new Student("Aradhna", 90, "ABC"));
        ...
        Thread t4 = new Thread(() -> System.out.println("Hello World - 4"));
        // t4.start();
        /*
        ...
        Streams do not update the original data
        */
        ...
        */
        ...
        // System.out.println(s1.limit(100).count());
        ...
        // }
        // if(res4.isPresent()) System.out.println("yes");
        // System.out.println(res4.equals(10));
